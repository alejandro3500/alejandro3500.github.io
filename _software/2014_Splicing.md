---
title: "Splicing: System for the construction of classifier's ensembles using Genetic Algorithms and diversity measures (2014, 2016)"
excerpt: ""
collection: software
---
...
[View software register v1.0](..\..\files\registro_software_SPLICING.pdf)

software register code v2.0: 0853-03-2016

<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/Splicing_CD.png" alt="splicing_cd" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
    Splicing's component diagram
  </figcaption>
</figure>

<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/Splicing.png" alt="splicing" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
    Splicing v1.2 UI
  </figcaption>
</figure>
