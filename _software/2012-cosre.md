...
Collaborators: Jennifer Pérez, Osnam Manso, Lester J. Velozo


<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/COSRE_relational_model.png" alt="cosre_rm" style="width: 100%;">
...
<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/COSRE_usecases.png" alt="cosre_uc" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
...
<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/COSRE_ui.png" alt="cosre_ui" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
    COSRE's main interface
  </figcaption>
</figure>
