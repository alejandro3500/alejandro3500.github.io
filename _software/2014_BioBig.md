...
Collaborator: Jesús D. Arias


<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/Biobig_main_interface.png" alt="biobig_mi" style="width: 100%;">
...
<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/Biobig_topics_ui.png" alt="biobig_topics_ui" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
    Topics UI in BioBig
  </figcaption>
</figure>
...
<figure style="float: left; margin: 0 0 10px 10px; width: 700px;">
  <img src="../../images/BioBig_exercise.png" alt="biobig_exercise" style="width: 100%;">
  <figcaption style="font-size: 0.9em; text-align: center;">
    Example of exercises in BioBig
  </figcaption>
</figure>
